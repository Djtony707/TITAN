    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-4">
        ...
        <div className="space-y-1">
          <div className="text-xs uppercase tracking-wide text-[#52525b] mb-2 flex items-center gap-1">
            <Calendar className="w-3 h-3" /> History
          </div>
          {dates.length === 0 && (
            <div className="text-xs text-[#52525b] p-2">No dreams yet. Run "Generate now" or wait for the nightly cron.</div>
          )}
