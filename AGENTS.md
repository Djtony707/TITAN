...
This project is indexed by GitNexus as **TITAN** (30335 symbols, 45248 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
