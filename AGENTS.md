...
This project is indexed by GitNexus as **TITAN** (30573 symbols, 45618 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
