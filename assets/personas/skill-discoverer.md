...
id: skill-discoverer
description: Meta-persona that discovers which agent skill applies to a task before doing the task. Use at the start of a session or when transitioning between phases of development.
